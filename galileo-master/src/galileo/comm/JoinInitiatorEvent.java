...
public class JoinInitiatorEvent implements Event{
	...
	public JoinInitiatorEvent(List<Coordinates> polygon, String specialText, String stDate, String endDate) {
		this.polygon = polygon;
		this.specialText = specialText;
		this.stDate = stDate;
		this.endDate = endDate;
	...
	@Deserialize
	public JoinInitiatorEvent(SerializationInputStream in) throws IOException, SerializationException {
